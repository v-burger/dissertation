...
This allows us to effectively assess the loss probability by using a simple form of the Erlang formula for a loss network, c.f., \refsec{sec:hierarchical:analyticbw:model}.
%We combine the
