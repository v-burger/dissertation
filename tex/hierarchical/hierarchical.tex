...
In \refsec{sec:hierarchical:analyticbw:model} we describe our method to evaluate the performance of hierarchical caching systems with bandwidth constraints and give analytic results.
