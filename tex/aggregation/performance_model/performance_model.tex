...
In \refsec{sec:aggregation:performance_model:analytical_model:2_systems} we introduce a Markov model for two links. The Markov model is extended in \refsec{sec:aggregation:performance_model:analytical_model:m_systems} to be applicable for two and more links using a fixed point approximation, allowing us to reduce the n-dimensional Markov chain to evaluate the steady state probabilities efficiently.

The models are used in \refsec{sec:aggregation:performance_model:numerical_examples} to study the characteristics of bandwidth aggregation systems and to determine optimal threshold settings for the offloading policy.
