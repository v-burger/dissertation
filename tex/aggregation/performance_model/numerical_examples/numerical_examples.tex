...
%In the following we analyze the performance of a system with two links.
...
Figure~\ref{fig:m2_comp} shows the blocking probability dependent on the system load of two links with equal arrival processes.
