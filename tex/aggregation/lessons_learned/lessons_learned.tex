...
A direct application is the aggregation of backhaul link bandwidth to increase the overall capacity of the system to cope with the increasing demand of traffic. %to reduce the load on cellular networks; carried by mobile networks, traffic is offloaded to Wi-Fi networks.
