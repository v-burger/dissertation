...
To evaluate the potential to further increase the bandwidth available in access networks, we analyze bandwidth aggregation systems in \refchap{chap:aggregation}.
