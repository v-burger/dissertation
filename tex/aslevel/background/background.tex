...
In \reffig{fig:aslevel:cdn} a content provider (AS 7) has a peering agreement with AS 1 and AS 3, such that AS 1 and AS 3 are not charged for the content delivered by the content provider.
