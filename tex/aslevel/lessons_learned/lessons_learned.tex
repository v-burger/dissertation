...
Finally, we analyzed the Internet census dataset to derive the distribution of IP-addresses on autonmous systems, to develop a model for the number of active subscribers in ISP networks.
To this end, we used 
