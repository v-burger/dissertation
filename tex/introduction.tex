...
By summing up the interaction between the systems in two offloading rates, the $m$-dimensional Markov chain is reduced to one dimension to achieve feasible computational complexity.
